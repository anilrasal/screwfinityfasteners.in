export const Icons = {
  ...
  phone: {
    paths: [
      {
        d: 'M2 3h4l2 5-3 2c1.5 3 4 5.5 7 7l2-3 5 2v4c0 1-1 2-2 2C9 22 2 15 2 6c0-1 1-2 2-2z',
      },
    ],
    class: 'mt-1.5 h-6 w-6 shrink-0 text-blue-500 dark:text-blue-400',
    viewBox: '0 0 24 24',
    fill: 'currentColor',
  },
  whatsapp: {
    paths: [
      {
        d: 'M16.7 2C9.6 2 4 7.6 4 14.7c0 2.6.8 5 2.2 7L4 22l2.4-.6c2 1.3 4.4 2 7 2 7.1 0 12.7-5.6 12.7-12.7S23.8 2 16.7 2zm0 23c-2.3 0-4.5-.6-6.4-1.8l-.5-.3-3.8 1 1-3.7-.3-.6c-1.3-2-2-4.3-2-6.6C4.7 8.1 10.1 2.7 16.7 2.7c6.6 0 12 5.4 12 12s-5.4 12.3-12 12.3zM20.5 17c-.3-.2-1.7-.8-2-1-.3-.1-.5-.2-.7.2-.2.3-.8 1-1 1.2-.2.2-.4.3-.7.1-.3-.2-1.3-.5-2.5-1.6-.9-.8-1.5-1.8-1.7-2.1-.2-.3 0-.5.1-.7.1-.1.3-.3.4-.5.1-.2.2-.3.3-.5.1-.2 0-.4 0-.6-.1-.2-.7-1.7-1-2.3-.3-.6-.6-.5-.8-.5h-.7c-.2 0-.6.1-.9.4-.3.3-1.1 1.1-1.1 2.7s1.1 3.1 1.3 3.3c.2.2 2.1 3.2 5.1 4.5.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.6-.1 1.7-.7 1.9-1.4.2-.7.2-1.3.1-1.4z',
      },
    ],
